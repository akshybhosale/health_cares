...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="https://akshybhosale.github.io/myshop" target="_blank" rel="noreferrer noopener">Akshay Bhosale</a> </strong>{'Copyright ©'}
...
const Footer = () => {
    return (
        <footer>
            <Box className='sticky-container' sx={{ bgcolor: 'secondary.main', color: 'text.primary', pb: 2, top: 'auto' }}>
                    ...
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            <Box>
                                ...
                                > <Avatar className='avatar' sx={{ mt: 1, mb: 1, mr: 1, bgcolor: 'white'}} style={{justifyContent: 'center'}}>
                                        <HealingTwoToneIcon
                                            color='primary'
                                            fontSize='Small' />
                                    </Avatar>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://maps.app.goo.gl/Sevtm9BZsQWETPmw9" target="_blank" rel="noopener noreferrer" >
                            ...
                            <Stack direction="row"
                                ...
                                alignItems="center"
                                spacing={1} sx={{m:1}}>
                                <Avatar className='avatar' sx={{ mb: 1, mt: 1, bgcolor: pink[500]}}>
                                    <EmailIcon />
                                </Avatar>
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.facebook.com/profile.php?id=100010635427663" target="_blank" rel="noopener noreferrer" >
                                    Akshay on Facebook
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.linkedin.com/in/akshay72/" target="_blank" rel="noopener noreferrer" >
                                    Akshay on LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/akshybhosale" target="_blank" rel="noopener noreferrer" >
                                    Akshay on GitHub
                                </a>
                            </Stack >
